...
def stats(request):
    zone_data = [Domain.objects.filter(zone='ygg').count(),
    ...
    week_data = [alfis.Blocks.select().filter(timestamp__gt=time.time()-86400).count(),
                 alfis.Blocks.select().filter(timestamp__gt=time.time()-86400*2, timestamp__lt=time.time()-86400).count(),
                 alfis.Blocks.select().filter(timestamp__gt=time.time()-86400*3, timestamp__lt=time.time()-86400*2).count(),
                 alfis.Blocks.select().filter(timestamp__gt=time.time()-86400*4, timestamp__lt=time.time()-86400*3).count(),
                 alfis.Blocks.select().filter(timestamp__gt=time.time()-86400*5, timestamp__lt=time.time()-86400*4).count(),
                 alfis.Blocks.select().filter(timestamp__gt=time.time()-86400*6, timestamp__lt=time.time()-86400*5).count(),
                 alfis.Blocks.select().filter(timestamp__gt=time.time()-86400*7, timestamp__lt=time.time()-86400*6).count()]
    static_domains = 0
    moving_domains = 0
